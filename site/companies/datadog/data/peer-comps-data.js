window.PEER_COMPS = {
  ...
  methodology: {
    ...
    valuation: "EV / LTM revenue uses reported trailing revenue. EV / NTM revenue uses the calendarized revenue-growth proxy; P / NTM FCF is market capitalization divided by NTM FCF while holding the latest standardized FCF margin constant.",
    ...
    fcf_multiples: "P / NTM FCF holds the latest standardized FCF margin constant. P / Owner FCF additionally subtracts SBC / revenue and is an analyst-adjusted sensitivity; it is shown as NM when owner FCF is zero or negative.",
